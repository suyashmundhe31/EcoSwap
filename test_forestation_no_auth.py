# Test script to verify forestation mint-coins works without authentication
...
def test_forestation_mint_coins_no_auth():
    print("🌲 Testing forestation mint-coins without authentication...\n")
    ...
    try:
        form_data = {
            ...
            'description': 'Testing minting without authentication',
            'price_per_coin': 10.0
        }
        ...
        if response.status_code == 200:
            data = response.json()
            print("✅ SUCCESS! Minting worked without authentication")
    ...
    # Test with different application ID if 12 doesn't exist
...
if __name__ == "__main__":
    test_forestation_mint_coins_no_auth()
